        ...
        <ScrollView style={{flex: 1, marginTop: 40}}>
            ...
            <View style={{margin: 10, marginTop: 5, marginBottom: 20}}>
                ...
                <FlatList
                    ...
                    renderItem={({item}) => (
                        <TouchableOpacity style={{margin: 10, backgroundColor: '#f9f9f9', borderRadius: 10, padding: 10, width: '45%'}} onPress={() => navigation.navigate('ProductDetails', {productId: item.id})}>
