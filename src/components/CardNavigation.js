...
export default function CardNavigation({icon, title, navigateTo, isExternalLink = false}){
    ...
    return(
        <TouchableOpacity onPress={handlePress}  style={{backgroundColor: '#ccc', borderRadius: 15, padding: 15, marginBottom: 15}}>
            <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                <View style={{flexDirection: 'row'}}>
                    <FontAwesome5 name={icon} size={20} color="#000" style={{}}/>
